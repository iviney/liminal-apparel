...
Spree::Config.set(:site_url => Rails.env.production? ? 'staging.liminal.org.nz' : 'localhost') # TBD can perhaps use request.host or SERVER_ADDRESS? But this is not run for evey request!
