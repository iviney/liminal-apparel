# copied from spree-core gem and modified

class AppConfiguration < Configuration


   :site_name, :string, :default => 'Liminal Apparel Store'
  preference :site_url, :string, :default => 'demo.spreecommerce.com' # TBD: change this
  preference :default_locale, :string, :default => 'en'
  preference :allow_locale_switching, :boolean, :default => true
  preference :default_country_id, :integer, :default => 12 # Australia (NZ is 145)
  ...
  preference :logo, :string, :default => '/images/admin/bg/spree_50.png'# TBD: change this
  preference :stylesheets, :string, :default => 'screen' # Comma separate multiple stylesheets, e.g. 'screen,mystyle'
  preference :admin_interface_logo, :string, :default => "admin/bg/spree_50.png" # change this
  ...
  preference :checkout_zone, :string, :default => "Liminal Sales Zone" # replace with the name of a zone if you would like to limit the countries
